...
Nota: Evitei usar a série B (ex.: B2s). Para a VM foi utilizado a instância  Standard_D2as_v5 (2 vCPU / 8 GiB), opção econômica e amplamente disponível.
...
# Desalocar/Parar manualmente (se quiser) e depois:
az group delete -n "$RG" --yes --no-wait

Apêndice – Dicas de Troubleshooting
